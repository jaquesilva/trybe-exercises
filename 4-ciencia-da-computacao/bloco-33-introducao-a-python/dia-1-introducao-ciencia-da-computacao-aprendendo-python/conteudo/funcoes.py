...
# e os parâmetros entre parênteses. Como todo bloco de código em Python, o
# caractere : define o início do bloco, e a indentação define seu fim.

# Os parâmetros podem ser passados de forma:
#  - posicional: são aqueles definidos por meio da posição em que cada um
# é passado;
...
soma(x=2, y=2)  # aqui est

# Os parâmetros também podem ser variádicos, ou seja, variam em sua quantidade

# Parâmetros posicionais variádicos são acessados como uma tupla no interior de
# uma função, e parâmetros nomeados variádicos como um dicionário.
...
print(dict(nome="Felipe", sobrenome="Silva", idade=25))  # cria um dicionário
# utilizando as chaves passadas

print(dict(nome="Ana", sobrenome="Souza", idade=21, turma=1))  # o número de
