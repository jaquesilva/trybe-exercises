...
-- 2. Monte uma query que una os resultados das tabelas customer e actor , exibindo os nomes que contêm a palavra "tracy" na tabela customer e os que contêm "je" na tabela actor . Exiba apenas os resultados 
-- únicos.
...
-- Minha tentativa:
(SELECT first_name, last_name, ‘-’ AS ‘customer_id’ FROM sakila.actor LIMIT 15)
UNION ALL
(SELECT first_name, last_name, customer_id FROM sakila.customer LIMIT 15)
ORDER BY first_name
LIMIT 15 OFFSET 15;
