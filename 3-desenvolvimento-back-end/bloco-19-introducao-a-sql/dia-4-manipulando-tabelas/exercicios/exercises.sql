...
INSERT INTO BoxOffice 
	(rating, domestic_sales, international_sales)
VALUES
...
-- 3. O diretor do filme "Procurando Nemo" está incorreto, na verdade ele foi dirigido por Andrew 
-- Staton. Corrija esse dado utilizando o UPDATE .
...
-- 4. O título do filme "Ratatouille" esta escrito de forma incorreta na tabela Movies , além disso, 
...
-- 5. Insira as novas classificações abaixo na tabela BoxOffice , lembre-se que a coluna movie_id é 
-- uma foreign key referente a coluna id da tabela Movies :
-- Monsters SA, classificado em 8.5, lucrou 300 milhões no mercado interno e 250 milhões no mercado 
-- internacional.
-- Os Incríveis, classificado em 7.4, lucrou 460 milhões no mercado interno e 510 milhões no mercado
-- internacional.
-- WALL-E, classificado em 9.9, lucrou 290 milhões no mercado interno e 280 milhões no mercado 
-- internacional.
